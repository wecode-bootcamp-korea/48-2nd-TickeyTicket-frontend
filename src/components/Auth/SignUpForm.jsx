      ...
      <div className="w-96 mx-auto pt-16 pb-14">
        ...
        <form onSubmit={submitSignUp}>
          ...
          <div className="mb-8">
            ...
            {name.length > 0 && (
              <p className="text-red-500">{auth.nameError}</p>
            )}
          </div>
          <div className="mb-8">
            <label className="block mb-3 text-base font-bold natural-800">
            ...
            <div className="flex-1 box-border">
              <div className="flex justify-between flex-row">
                <label className="relative flex items-center pb-2">
                  <input
                    type="checkbox"
                    id="genderMan"
                    className="inline-block relative w-5 h-5 border-box border border-gray-300 rounded bg-white mr-2 cursor-pointer"
                  />
                  <label for="genderMan" className="cursor-pointer">
                    남성
                  </label>
                </label>
                <label className="relative flex items-center pb-2">
                  <input
                    ...
                    className="inline-block relative w-5 h-5 border-box border border-gray-300 rounded bg-white mr-2 cursor-pointer"
                  />
                  <label for="genderFemale" className="cursor-pointer">
                    여성
                  </label>
                </label>
                <label className="relative flex items-center pb-2">
                  <input
                    ...
                    className="inline-block relative w-5 h-5 border-box border border-gray-300 rounded bg-white mr-2 cursor-pointer"
                  />
                  <label for="genderNone" className="cursor-pointer">
                    선택안함
                  </label>
                </label>
              </div>
          ...
          <button className="w-full mt-8 bg-pink-500 border-pink-500 text-white py-3 rounded cursor-pointer">
            회원가입하기
          </button>
        </form>
